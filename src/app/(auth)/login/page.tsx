        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-soft">
            ...
            <div className="mt-8 space-y-4">
                <button
                    ...
                    className="flex w-full items-center justify-center rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1"
                >
