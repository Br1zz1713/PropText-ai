                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="rounded-3xl border border-slate-200/50 bg-white p-8 shadow-sm dark:border-white/5 dark:bg-[#0b0f1a] transition-all hover:shadow-md">
                                ...
                                <div className="col-span-full">
                                    ...
                                    >
                                        <option className="dark:bg-[#0b0f1a]">Apartment</option>
                                        <option className="dark:bg-[#0b0f1a]">House</option>
                                        <option className="dark:bg-[#0b0f1a]">Villa</option>
                                        <option className="dark:bg-[#0b0f1a]">Penthouse</option>
                                        <option className="dark:bg-[#0b0f1a]">Commercial Space</option>
                                    </select>
                                </div>
                                <div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-xl bg-slate-50 border-transparent px-4 py-3.5 text-sm font-medium text-foreground transition-all focus:bg-white focus:ring-1 focus:ring-black/20 dark:bg-white/5 dark:focus:bg-white/10 dark:focus:ring-white/20 outline-none"
                                >
                                    <option className="dark:bg-[#0b0f1a]">Professional</option>
                                    <option className="dark:bg-[#0b0f1a]">Luxury</option>
                                    <option className="dark:bg-[#0b0f1a]">Warm</option>
                                    <option className="dark:bg-[#0b0f1a]">Modern</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-xl bg-slate-50 border-transparent px-4 py-3.5 text-sm font-medium text-foreground transition-all focus:bg-white focus:ring-1 focus:ring-black/20 dark:bg-white/5 dark:focus:bg-white/10 dark:focus:ring-white/20 outline-none"
                                >
                                    <option className="dark:bg-[#0b0f1a]">English</option>
                                    <option className="dark:bg-[#0b0f1a]">German</option>
                                    <option className="dark:bg-[#0b0f1a]">French</option>
                                    <option className="dark:bg-[#0b0f1a]">Spanish</option>
                                </select>
                            </div>
                        </div>
                    </div>
