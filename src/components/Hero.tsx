        ...
        <section className="relative overflow-hidden pt-36 pb-24 lg:pt-48 lg:pb-32">
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
                    ...
                    <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 mb-8 backdrop-blur-md transition-all hover:bg-white/10 hover:border-white/20">
                    ...
                    <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-white/70 mb-8 leading-[1.1]">
                        Property descriptions <br className="hidden md:block" />
                        that <span className="text-white">sell themselves.</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto mb-20 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                        ...
                        <Link
                            href="#how-it-works"
                            className="inline-flex items-center justify-center rounded-full border border-white/10 bg-white/5 px-8 py-4 text-base font-medium text-white shadow-sm backdrop-blur-sm transition-all hover:bg-white/10 hover:border-white/20"
                        >
